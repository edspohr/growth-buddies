...
exports.sendGuideDelivery = onDocumentCreated(
  ...
  async (event) => {
    ...
    const crmBody = `
      ...
      ${ctaButton(`https://wa.me/56975991366?text=${encodeURIComponent(waMsg)}`, "💬 Responder por WhatsApp", "#25d366", "#fff")}
...
exports.notifyNewLead = onDocumentCreated(
  ...
  async (event) => {
    ...
    const whatsappLink = `https://wa.me/56975991366?text=${encodeURIComponent(waMsg)}`;
    ...
    for (const doc of guideSnap.docs) {
      ...
      if (days >= 2 && days < 3 && !lead.followup_day2_sent) {
        const body = `
          ...
          ${ctaButton("https://wa.me/56975991366?text=" + encodeURIComponent("Hola Edmundo, leí la guía y me interesa el triaje inteligente de documentos."), "💬 Conversar por WhatsApp", "#25d366", "#fff")}
      ...
      // Day 10 — Soft CTA + scarcity
        ...
        const body = `
          ...
          <p style="margin-top:16px;text-align:center;font-size:14px;color:#64748b;">¿Prefieres WhatsApp? <a href="https://wa.me/56975991366?text=${waText}" style="color:#25d366;text-decoration:none;">Escríbeme directo →</a></p>`;
    ...
    for (const doc of snapshot.docs) {
      ...
      // Day 7 — Last chance + scarcity
        ...
        const body = `
          ...
          <p style="margin-top:16px;text-align:center;font-size:14px;color:#64748b;">¿Prefieres WhatsApp? <a href="https://wa.me/56975991366?text=${encodeURIComponent(`Hola Edmundo, soy ${lead.name || "un interesado"}, quiero coordinar la sesión de calificación.`)}" style="color:#25d366;text-decoration:none;">Escríbeme directo →</a></p>`;
